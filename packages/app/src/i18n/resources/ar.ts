    ...
    file: {
      ...
      image: {
        ...
        desktopAccessibilityHint:
          "استخدم عجلة الماوس أو عناصر التحكم للتكبير. اسحب الصورة المكبرة لتحريكها.",
        copy: "نسخ الصورة",
        copying: "جارٍ نسخ الصورة...",
        copyFailed: "فشل نسخ الصورة",
        save: "حفظ في الصور",
        saving: "جارٍ حفظ الصورة...",
        saved: "تم الحفظ في الصور",
        savePermissionDenied: "اسمح بالإضافة إلى الصور لحفظ هذه الصورة",
        saveFailed: "فشل حفظ الصورة",
        shareFailed: "فشلت مشاركة الصورة",
        zoomOut: "تصغير",
        resetZoom: "إعادة ضبط التكبير",
        zoomIn: "تكبير",
        zoomLevel: "التكبير {{percent}}٪",
      },
      editor: {
