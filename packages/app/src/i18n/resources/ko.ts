  ...
  panels: {
    ...
    file: {
      ...
      image: {
        ...
        accessibilityHint:
          "손가락을 모으거나 두 번 탭하여 확대 또는 축소하세요. 이미지 작업을 보려면 길게 누르세요.",
        desktopAccessibilityHint:
          "마우스 휠이나 컨트롤로 확대 또는 축소하세요. 확대된 상태에서 드래그하여 이동하세요.",
        copy: "이미지 복사",
        copying: "이미지 복사 중...",
        ...
        saving: "이미지 저장 중...",
        saved: "사진에 저장됨",
        savePermissionDenied: "이 이미지를 저장하려면 사진 접근을 허용하세요",
        saveFailed: "이미지를 저장하지 못했습니다",
        shareFailed: "이미지를 공유하지 못했습니다",
        zoomOut: "축소",
        resetZoom: "확대 또는 축소 초기화",
        zoomIn: "확대",
        zoomLevel: "확대 수준 {{percent}}%",
      },
      editor: {
        fileSize: "파일 크기 {{size}}",
        lines: "{{count}} 라인",
